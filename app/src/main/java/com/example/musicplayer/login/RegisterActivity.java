...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void setupRetrofit() {
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        authApi = retrofit.create(DeezerApi.class);
    }
    ...
    private void handleRegister() {
        ...
        LoginActivity.RegisterRequest registerRequest = new LoginActivity.RegisterRequest(username, email, password,
                fullName);
        ...
        authApi.register(registerRequest).enqueue(new Callback<LoginActivity.AuthTokenResponse>() {
            ...
            public void onResponse(@NonNull Call<LoginActivity.AuthTokenResponse> call,
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(RegisterActivity.this, "Tên đăng nhập hoặc email đã tồn tại", Toast.LENGTH_SHORT)
                            .show();
                }
            }
