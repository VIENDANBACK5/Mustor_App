    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        switch (role) {
            ...
            case "bot":
                ...
                // Thêm hiệu ứng cho tin nhắn đang trả lời
                if (msg.isTyping()) {
                    holder.botContentView.setAlpha(0.7f);
                    holder.botContentView.setTextColor(0xFFBBBBBB);
                } else {
                    holder.botContentView.setAlpha(1.0f);
                    holder.botContentView.setTextColor(0xFFFFFFFF);
                }
                break;
