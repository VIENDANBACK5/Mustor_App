...
public class PlayerActivity extends AppCompatActivity {
    ...
    private void setupRetrofit() {
        ...
        Log.d(TAG, "✅ Retrofit setup complete. deezerApi initialized: " + (deezerApi != null));
    }
    ...
    private void saveHistoryOnComplete(Song song) {
        ...
        // Check if deezerApi and historyManager are initialized
        ...
        // ⭐ Use auto-save API (recommended) - backend automatically fetches track info from Deezer
